<div class="span6" >
  <div class="panel_block" >
    ...
    <ul>
      <li>
        <input placeholder="企业名称"  type="text" class="long"  name="title" value="<?php echo  $app['title'];?>" />
  ...
  <div class="panel_block" >
    ...
    <form method="POST" >
      <ul>
        <li><textarea class="long" name="category" style="width:90%;height:80px;"><?php echo  $data['category'];?></textarea><input type="submit" value="确认提交" /></li>
      </ul>
    </form> 
  </div>
        ...
        <table>
          ...
          <?php foreach($users as $u){?>
            <tr>
              ...
              <td><?php echo  $app['admin'] == $u['id']?'管理员':'<a href="?/store/sys/remove/'.$u['id'].'" >删除</a> <a href="?/store/sys/reset/'.$u['id'].'" >清空密码</a>';?> </td>
            </tr>
          <?php }?>
        </table></li>
